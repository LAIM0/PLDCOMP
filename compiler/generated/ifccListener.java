...
public interface ifccListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLvalueExp(ifccParser.LvalueExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lvalueExp}
	 * labeled alternative in {@link ifccParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitLvalueExp(ifccParser.LvalueExpContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterArrayAccessExp(ifccParser.ArrayAccessExpContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arrayAccessExp}
	 * labeled alternative in {@link ifccParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitArrayAccessExp(ifccParser.ArrayAccessExpContext ctx);
	/**
	 ...
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void enterArrayAccessLvalue(ifccParser.ArrayAccessLvalueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arrayAccessLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void exitArrayAccessLvalue(ifccParser.ArrayAccessLvalueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code addressofLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void enterAddressofLvalue(ifccParser.AddressofLvalueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code addressofLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void exitAddressofLvalue(ifccParser.AddressofLvalueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code parLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void enterParLvalue(ifccParser.ParLvalueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code parLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void exitParLvalue(ifccParser.ParLvalueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code dereferenceLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void enterDereferenceLvalue(ifccParser.DereferenceLvalueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code dereferenceLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void exitDereferenceLvalue(ifccParser.DereferenceLvalueContext ctx);
	/**
	 * Enter a parse tree produced by the {@code varLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void enterVarLvalue(ifccParser.VarLvalueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code varLvalue}
	 * labeled alternative in {@link ifccParser#lvalue_expression}.
	 * @param ctx the parse tree
	 */
	void exitVarLvalue(ifccParser.VarLvalueContext ctx);
	/**
